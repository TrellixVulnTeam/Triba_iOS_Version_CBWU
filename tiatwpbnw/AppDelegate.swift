...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //The normal stuff is below
    // ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓
    
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // Override point for customization after application launch.
        //            NSAttributedStringKey.font: UIFont(name: "Helvetica Neue", size: 23)!

        
   /*   let attrs = [
            NSAttributedStringKey.foregroundColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1),
            NSAttributedStringKey.font: UIFont(name: "Quantico-Regular", size: 23)!
...
*/
       ...
       // UITabBar.appearance().unselectedItemTintColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
        ...
        tabBar.backgroundImage = UIImage.imageWithColor(color: UIColor.clear)
