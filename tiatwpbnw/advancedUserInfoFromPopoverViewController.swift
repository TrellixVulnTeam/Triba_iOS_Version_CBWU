//
//  advancedUserInfoFromPopoverViewController.swift
//  tiatwpbnw
//
...
class advancedUserInfoFromPopoverViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
    ...
    @IBOutlet weak var lblModStatus: UILabel!
    @IBOutlet weak var lblStrikeNumber: UILabel!
    @IBOutlet weak var collectionStrikedPosts: UICollectionView!
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: self.collectionStrikedPosts.frame.width * 0.95 , height: 135)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.lblUserFullName.text = userFullName
        ...
        if(userAccessLevel == "LOCALMODERATOR"){
            lblModStatus.text = "Status: Moderator"
            
        }
        else if(userAccessLevel == "ADMIN"){
            lblModStatus.text = "Status: ADMIN"

            
        }
        else{
            lblModStatus.text = "Status: Active User"
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        imgProfilePic.sd_setImage(with: imageUrl)
        // self.imageProfilePic.layer.cornerRadius = 10
        imgProfilePic.layer.cornerRadius = 12
        imgProfilePic.clipsToBounds = true
        imgProfilePic.layer.borderWidth = 2
        imgProfilePic.layer.borderColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
        
        self.lblUserFullName.text = userFullName as? String
        ...
        ref?.child("strikedPostHistory").child(userID).queryLimited(toLast: 10).observe(.childAdded, with: { (snapshot) in
            if let strikedPostObjectDict = snapshot.value as? [String: AnyObject]{
                ...
                if(isValidPost){
                    ...
                    self.strikedPostsList.append(strikedObjectt)
                    self.collectionStrikedPosts.reloadData()
